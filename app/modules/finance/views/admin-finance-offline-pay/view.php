...
//            'updated_at',
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            ?>
                            <?=Html::a(Yii::t('rabint','تایید'),["/finance/default/offline-pay-change-status","id"=>$model->id,"status"=>\app\modules\finance\models\FinanceOfflinePay::STATUS_ACCEPTED],['class'=>'btn btn-success d-block mr-auto ml-auto mb-2'])?>
                            <?php else: ?>
