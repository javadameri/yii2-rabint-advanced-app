    ...
    [
        ...
        'buttons' => [
            'accept' => function ($url, $model) {
                if($model->status==\app\modules\finance\models\FinanceOfflinePay::STATUS_ACCEPTED){
                    return "";
                }else{
                    return \yii\bootstrap4\Html::a('<i class="fas fa-check"></i>', ["/finance/default/offline-pay-change-status","id"=>$model->id,"status"=>\app\modules\finance\models\FinanceOfflinePay::STATUS_ACCEPTED], [
