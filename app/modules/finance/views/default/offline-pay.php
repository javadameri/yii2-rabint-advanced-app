...
<div class="cantiner">
    <div class="row">
        ...
        <div class="col-sm-12"><span><?=Yii::t('rabint','لطفا مبلغ {amount} تومان را به شماره کارت {cart_id} بانک {bank} به نام {name} واریز نمایید واطلاعات را در این قسمت وارد کنید.',['amount'=>$model->amount,'cart_id'=>config('card.id'),'name'=>config('card.name'),'bank'=>config('card.bank')])?></span></div>
        <div class="col-sm-6">
            <div class="row">
