...
return [
    ...
    [
        ...
        'attribute' => 'status',
        'enum' => yii\helpers\ArrayHelper::getColumn(app\modules\finance\models\FinanceDraft::statuses(), 'title'),
        'format' => 'raw',
        'value' => function ($model) {
            return '<span class="label label-' . app\modules\finance\models\FinanceDraft::statuses()[$model->status]['class'] . '">' . app\modules\finance\models\FinanceDraft::statuses()[$model->status]['title'] . '</span>';
        }
    ],
    'description:ntext',
    [
    ...
    [
        ...
        'updateOptions' => ['role' => 'modal-remote', 'title' => Yii::t('rabint', 'بروز رسانی'), 'data-toggle' => 'tooltip'],
        'deleteOptions' => [
