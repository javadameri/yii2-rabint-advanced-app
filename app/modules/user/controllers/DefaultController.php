    ...
    public function actions()
    {
        return [
            'avatar-upload' => [
                ...
                'modelName' => \app\modules\user\models\UserProfile::className(),
...
//            ],
    ...
    public function actionIndex()
    {
        ...
        $User = \app\modules\user\models\User::findOne(['id' => $user_id]);
...
//        die('--');
    ...
    public function actionOfficialData()
    {
        ...
        $model = new \app\modules\user\models\OfficialForm();
...
//                $user->is_official = \app\modules\user\models\User::IS_OFFICIAL_WAITING;
                $user->save();
                Yii::$app->notify->send(
...
//        }else{
            $user  = \app\modules\user\models\User::findOne($uid);
            if(!$user){
...
//        }
    ...
    public function actionChangePassword($redirect = null, $cancel = 0)
    {
        ...
        $model = new \app\modules\user\models\ChangePasswordForm();
