...
use app\modules\user\models\AdminUserForm;
use app\modules\user\models\search\AdminUserSearch;
...
//            ]
    ...
    public function actionIndex() {
        ...
        if(!Yii::$app->user->can('administrator') and !Yii::$app->user->can('manageUsers')){
