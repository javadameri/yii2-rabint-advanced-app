...
$mergeRegLogin = \app\modules\user\Module::getConfig('mergeRegisterAndLogin');
?>
...
<div class="site-login">
    ...
    <div class="col-sm-12">
        ...
        <?php
        if (\app\modules\user\Module::getConfig('tenants')) {
            $t = \app\modules\user\Module::getConfig('tenants');
        ...
        <?php if (\app\modules\user\Module::getConfig('enableCaptcha')): ?>
            <div class="form-group center">
                <?php
                switch (\app\modules\user\Module::getConfig('enableCaptcha')) {
        ...
        <div class="form-group center">
            <?php echo Html::submitButton(
                $mergeRegLogin ? Yii::t('rabint', 'ورود') : Yii::t('rabint', 'ورود'),
        ...
        <div class="form-group center" style="color:#999;margin:1em 0">
            <p>
                <?php
                if (!$mergeRegLogin && \app\modules\user\Module::getConfig('enableActivation')) {
                    echo Html::a(Yii::t('rabint', 'ثبت نام'), ['activation', 'identity' => '', 'redirect' => $model->redirect], $linkOptions);
                    echo ' | ';
                }
                ?>
                <?php
                echo Html::a(Yii::t('rabint', 'فراموشی رمز'), ['activation', 'identity' => $model->identity, 'redirect' => $model->redirect], $linkOptions);
                ?>
            </p>
        </div>
        <?php ActiveForm::end(); ?>
