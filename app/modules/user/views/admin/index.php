...
/* @var $searchModel app\modules\user\models\search\AdminUserSearch */
...
//                                ],
                                ...
                                [
                                    ...
                                    'label' => 'اعتبارکیف پول(تومان)',
                                    'value' => function ($data) {
                                        return \app\modules\finance\models\FinanceWallet::cash($data->id);
                                    }
                                ],
//                                    [
//                                    'class' => \rabint\components\grid\JDateColumn::className(),
...
//                                            if(rabint\helpers\user::role($model->id)=='administrator')return;
                                        ...
                                        'delete' => function ($url, $model) {
                                            if(!Yii::$app->user->can('manageUsers') )return false;
