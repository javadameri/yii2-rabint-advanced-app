...
/* @var $model app\modules\user\models\AdminUserForm */
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            echo $form->field($model, 'gender')->dropDownlist([
                \app\modules\user\models\UserProfile::GENDER_FEMALE => Yii::t('rabint', 'Female'),
                \app\modules\user\models\UserProfile::GENDER_MALE => Yii::t('rabint', 'Male')
            ], ['prompt' => ''])
            ?>
