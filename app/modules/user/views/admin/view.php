...
<div class="user-view">
    ...
    <br/>
    <p>
        <?php echo Html::a(Yii::t('rabint', 'بروز رسانی'), ['update', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
        <?php
...
//            'auth_key',
                        ...
                        [
                            'attribute' => 'status',
                            'value' => app\modules\user\models\User::statuses()[$model->status]['title'],
                        ],
                        [
                            'attribute' => 'locale',
                        ...
                        [
                            ...
                            'value' => ($model->userProfile->gender) ? app\modules\user\models\UserProfile::genders()[$model->userProfile->gender]['title'] : NULL,
                        ],
                        [
                            'attribute' => 'phone',
