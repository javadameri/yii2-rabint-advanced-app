...
class Module extends \yii\base\Module
{
    ...
    public static function getConfig($key)
    {
        $defaultConfigs = [
            ...
            'show_account_in_dropdown' => false,
        ...
        return [
            ...
            'items' => [
                ...
                [
                    ...
                    'url' => [\app\modules\user\Module::getConfig('profile_action')],
    ...
    public static function AdminMenu()
    {
        return [
            ...
            [
                ...
                'url' => '#',
                'visible' => (Yii::$app->user->can('administrator') || Yii::$app->user->can('manageUsers') || Yii::$app->user->can('viewUsers') || Yii::$app->user->can('createUsers')),
                'icon' => '<i class="fas fa-user"></i>',
                'items' => [
                    [
                        'label' => \Yii::t('rabint', 'لیست کاربران'),
                        'url' => ['/user/admin/index'],
                        'visible' => (Yii::$app->user->can('administrator') || Yii::$app->user->can('manageUsers') || Yii::$app->user->can('viewUsers')),
