...
use app\modules\user\behaviors\LoginTimestampBehavior;
 ...
 *
 * @property \app\modules\user\models\UserProfile $userProfile
 */
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function behaviors()
    {
        return [
            ...
            LoginTimestampBehavior::className(),
            'auth_key' => [
...
//        $return[] = ['email', 'required'];
        ...
        if(\app\modules\user\Module::getConfig('enableCaptcha')){
...
//        }
//        if (!\app\modules\user\Module::$cellBaseAuth && empty($email)) {
...
EOT;
    ...
    public function getCommentName()
    {
        ...
        $username[7]="*";
        $username[8]="*";
        return \yii\helpers\Html::encode($username);
    }
    //
