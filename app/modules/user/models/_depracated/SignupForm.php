...
class SignupForm extends Model
{
    ...
    public function rules()
    {
         ...
         * cell validations
         */
        if (\app\modules\user\Module::$cellBaseAuth) {
    ...
    {
        return [
            'username' => (\app\modules\user\Module::$cellBaseAuth) ? Yii::t('rabint', 'تلفن همراه') : Yii::t('rabint', 'نام کاربری'),
...
//    }
    ...
    {
        return \app\modules\user\Module::$shouldBeActivated;
