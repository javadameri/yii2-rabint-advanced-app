 ...
 * @property string $hesab
 * @property string $cart_no
 *
 * @property User $user
 */
...
//                            'maxSize' => 1024 * 1024 * 10, // 1 MB
    ...
    public function rules() {
        return [
                ...
                [['firstname', 'nickname', 'lastname','shaba','hesab','cart_no'], 'string', 'max' => 255],
...
//                ['locale', 'in', 'range' => array_keys(Yii::$app->params['availableLocales'])],
    ...
    public function attributeLabels() {
        return [
            ...
            'shaba' => Yii::t('rabint', 'سریال شناسنامه'),
            'hesab' => Yii::t('rabint', 'سریال شناسنامه'),
            'cart_no' => Yii::t('rabint', 'سریال شناسنامه'),
        ];
    }
