...
//    {
//        if ((empty($media) && \app\modules\user\Module::$cellBaseAuth) OR $media = self::MEDIA_SMS) {
...
//        ]);
//        --data-urlencode "receptor=09366133558"  \
//--data-urlencode "sender=20006535"  \
//--data-urlencode "token=20006535"  \
//--data-urlencode "template=activecode"  \
        return (new kavenegar("3553546C423131534E6A724F64465946384137326F6B46733955715A6D5A4E30"))->VerifyLookup($user->mobile,$token->token,"activecode");
//        return (new AmootSms)->sendToken($user->mobile,$token->token);
