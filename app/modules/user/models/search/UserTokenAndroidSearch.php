...
use app\modules\user\models\UserTokenAndroid;

/**
 * UserTokenAndroidSearch represents the model behind the search form about `\app\modules\user\models\UserTokenAndroid`.
 */
