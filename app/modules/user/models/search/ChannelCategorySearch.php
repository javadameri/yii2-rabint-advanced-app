...
use app\modules\user\models\ChannelCategory;

/**
 * ChannelCategorySearch represents the model behind the search form about `app\modules\user\models\ChannelCategory`.
 */
